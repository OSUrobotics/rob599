...
// Bill Smart
//
// This is an example of a simple publisher in ROS 2, showing how to clean up some of the
// syntactic mess of namespaces.
...
public:
	// Define an alias to make things look cleaner.
